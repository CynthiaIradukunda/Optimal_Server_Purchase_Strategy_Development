...
prob = LpProblem('Server_Month4', LpMinimize)
...
prob += server_capacity['Standard_Intel_Pentium_PC']*s1 + server_capacity['Enhanced_Intel_Pentium_PC']*s2 + \
    ...
    server_capacity['Sun_Workstation']*s4 >= cumulative_number_employees[4] - cumulative_number_employees_covered_soFar , "Server_Capacity_Month4"
...
print("Optimized Total Cost - Month 4: $", value(prob.objective))
