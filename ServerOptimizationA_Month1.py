...
prob = LpProblem('Server_Month1', LpMinimize)
...
prob += server_capacity['Standard_Intel_Pentium_PC']*s1 + server_capacity['Enhanced_Intel_Pentium_PC']*s2 + \
    ...
    server_capacity['Sun_Workstation']*s4 >= cumulative_number_employees[1], "Server_Capacity_Month1"
print(prob)
...
print("Optimized Total Cost - Month 1: $", value(prob.objective))
